...
namespace WindowsFormsAppLab10
{
    public partial class Form1 : Form
    {
        ...
        {
            TCircle cl = new TCircle(Convert.ToInt32(textBox1.Text));
        ...
        {
            TCircle cl = new TCircle(Convert.ToInt32(textBox1.Text));
            textBox6.Text = cl.comparison_length(Convert.ToInt32(textBox2.Text)).ToString();
        }

        private void button6_Click(object sender, EventArgs e)
        {
            TSphere cl = new TSphere(Convert.ToInt32(textBox1.Text));
            textBox7.Text = cl.surface_of_the_ball().ToString();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            TSphere cl = new TCircle(Convert.ToInt32(textBox1.Text));
